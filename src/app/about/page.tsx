...
* Answer  : It displays an "About Us" page with a styled heading and a link to navigate back to the homepage.
* 
* ----------------___________________
...
* - First commant line
*   - Changed //AboutUs Page to // Component Name: AboutPage
* - changed component name from Page to AboutPage
